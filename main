DATA_SEG    SEGMENT
    MSG1    DB  'Stack,near, 32*L+7*M^2',13,10,'$'
...
CODE_SEG    SEGMENT
   ...
   NUMS PROC NEAR
            ...
            MOV     AX, 32                 ;Preparing mul by 322
            MOV     BX, [BP-2]             ;Getting first num from stack
            MUL     BX                     ;Mul AX by BX
            MOV     BX, AX                 ;Store result in BX
            
            MOV     AX, [BP-4]             ;Getting second num from stack
            MOV     CX, [BP-4]             ;Getting second num from stack
    ...
    NUMS endp   
        ...
        CALL_FUNC: 
            PUSH    0                     ;Reserving space for result
            CALL NUMS                     ;Calling procedure
            
            
        DISPLAYING:
            
            POP     AX                    ;Getting the result
